...
class CurrencyEditView: UIView, UITextFieldDelegate {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(CurrencyEditView.keyboardWillShow(_:)), name: UIKeyboardWillShowNotification, object: nil)
        NSNotificationCenter.defaultCenter().addObserver(self, selector: #selector(CurrencyEditView.keyboardWillHide(_:)), name: UIKeyboardWillHideNotification, object: nil)
